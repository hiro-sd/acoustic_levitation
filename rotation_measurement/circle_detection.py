...
# 浮揚画像フォルダのパス
folder_path = "/Users/yoshidahiroto/Downloads/修士関連/acoustic_levitation/rotation_measurement/syukai_onba"

# 出力フォルダを作成
output_folder = os.path.join(os.path.dirname(folder_path), "/Users/yoshidahiroto/Downloads/修士関連/acoustic_levitation/rotation_measurement/detected_circles_syukai")
